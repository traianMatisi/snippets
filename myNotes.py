...
# [The python 3 installation on linux]
# How to install pygame in linux
# sudo apt install python3-pip
# sudo apt install python3-pygame


# [Commenting, docstring and documentation]
# '''
# Coment1 Multi-line single quotes
# '''

# """
# Comment2 Multi-line double quotes
# """

# #Comment3 Single line

# def my_function():
#     """ The first indented line with the muti-line comment is the docstring. """
...
# COOL N CHILL PY3 tricks #

# import os modules,  os names: /// 'nt' == 'windows' /// 'posix' == 'linux/macos' ///

# nested input -=> if input('Enter something: ') == my_variable:

# dictionary of functions
# def my_ft(a, b):
# my_dict = {'call_me': my_ft}
# calling = my_dict['call_me']
# calling(a, b) WILL REPLICATE my_ft(a, b)
...
# print(random.choice(['Nenhum', 'Lyan', 'Leon', 'Lucca', 'Luigi', 'Luna']))
